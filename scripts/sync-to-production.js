...
// Configuración
const PROD_REPO_URL = process.env.PROD_REPO_URL; // Asegúrate de que esta variable esté en Render
...
// Configurar Git para commits (¡importante!)
...
// Archivos a copiar (desde la carpeta 'public')
const filesToCopy = [
    ...
    // No copies data/menu.json porque los JS usan la API de Render
];
...
// Copiar imágenes permitidas (desde la carpeta 'img' de Render)
const allowedImages = [
    'platillo1.jpg',
    'platillo2.png', 
    'platillo3.jpg',
