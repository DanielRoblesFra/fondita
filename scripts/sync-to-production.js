[file name]: scripts/sync-to-production.js
[file content begin]
...
const filesToCopy = [
    ...
    { src: 'menu.js', dest: 'menu.js' },
    { src: 'la-carta.js', dest: 'la-carta.js' },
    { src: 'menu-semana.js', dest: 'menu-semana.js' },
    { src: 'preguntas.js', dest: 'preguntas.js' },
    { src: 'scoll.js', dest: 'scoll.js' },
